...
if($calificacion>5 && $calificacion<=8){
    echo "suerte de principiante sacaste".$calificacion;
    echo "<img src='medio.jpg' width= '3%'><hr>";

}elseif($calificacion<5){
    echo "no sabes nada de maneskin sacaste ".$calificacion;
    echo "<img src='triste.jpg' width= '3%'><hr>";
}elseif($calificacion>8){
    echo "si les sabes a los maneskin sacaste ".$calificacion;
    echo "<img src='carita_feliz.jpg' width= '3%'><hr>";
}
